...
const { atomicWriteJson } = require('./atomicWrite.js');
// Disk persistence for the event log. Atomic write (lib/atomicWrite.js) so a crash never leaves a
