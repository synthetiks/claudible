...
const DEFAULT_RELAY_URL = '';   // set to wss://claudible-presence.<account>.workers.dev after deploying relay/ — until then the whole module is inert
...
module.exports = { makePresenceRelay, mergePeerFrame, roomKeyFor, RELAY_URL };
