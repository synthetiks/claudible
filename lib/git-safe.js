...
// (CASE-12/22/23 + B-25). wsl/_git-safe.sh and hooks/context-hook.js each carry their OWN copy of this list
...
// workspace on every single prompt, so this is a per-turn exposure, not a rare one. core.hooksPath (CASE-22):
