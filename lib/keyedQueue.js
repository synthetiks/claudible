...
// front work stays FIFO among itself, and never preempts the task already running). NOTE: no production code
// uses front today — presence got its own separate lane instead (main.js _presQ), because front-of-queue can
// only jump WAITING work, never a multi-second task already RUNNING. The option stays as a tested primitive.
