...
function authEnvFor(token) {
  ...
  // CASE-22: composed through the shared allowlist (gitSafe.buildEnv) instead of emitting its own competing
...
function git(args, cwd, authEnv) {
  return new Promise((resolve) => {
    // CASE-22: no authEnv given (public repo) still gets the shared neutralization — previously env was left
